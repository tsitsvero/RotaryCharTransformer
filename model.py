...
class GPTConfig:
    ...
    use_rational: bool = True # True: use Rational activation, False: use GELU
    use_rotary: bool = True  # True: use rotary embeddings (RoPE), False: use regular positional embeddings
...
class GPT(nn.Module):
    ...
    def configure_optimizers_with_stiefel(self, weight_decay, learning_rate, betas, device_type, use_stiefel=True):
